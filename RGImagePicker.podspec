...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/RengeRenge/RGImagePicker.git"
  ...
  s.source       = { :git => "https://github.com/RengeRenge/RGImagePicker.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "RGImagePicker", "RGImagePicker/**/*.{h,m}"
  ...
  s.dependency 'FLAnimatedImageView+RGWrapper'
  s.dependency 'RGUIKit'
  s.dependency 'RGImageGallery'
end
